...
public class EmployeeRoster {
    ...
    public void displayHE(){
        myList.stream().filter(emp -> emp instanceof HourlyEmployee).forEach(emp -> emp.display());
    }
    
    public void displayCE(){
        myList.stream().filter(emp -> emp instanceof CommissionEmployee && !(emp instanceof BasePlusCommissionEmployee)).forEach(emp -> emp.display());
    }
    
    public void displayBPCE(){
        myList.stream().filter(emp -> emp instanceof BasePlusCommissionEmployee).forEach(emp -> emp.display());
    }
    
    public void displayPWE(){
        myList.stream().filter(emp -> emp instanceof PieceWorkerEmployee).forEach(emp -> emp.display());
    }
